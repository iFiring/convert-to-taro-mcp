...
export class JsSyntaxPrompt {
    constructor() {
        this.name = "prompt-for-js-syntax-convertor";
        this.description = "js 文件的语法转换方案";
        this.arguments = JsSyntaxPromptInputSchema.shape;
        this.syntaxFilePath = "./prompts/js-syntax-convertor.md";
    }
    /**
     * 生成JS语法转换提示词
     * @param args - 提示词参数
     ...
     * @returns 生成的内容
     */
    generateContentForFile(syntaxContent, filePath, targetRule) {
...
//# sourceMappingURL=js-syntax.js.map